...
func (x *Timestamp) GetSecond() int64 {
	if x != nil {
		return x.Second
	}
	return 0
...
func (x *Timestamp) GetYear() int64 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *Timestamp) GetMonth() int64 {
	if x != nil {
		return x.Month
	}
	return 0
...
type Duty struct {
	...
	TeacherFullName string `protobuf:"bytes,1,opt,name=teacher_full_name,json=teacherFullName,proto3" json:"teacher_full_name,omitempty"`
	PlaceFullName   string `protobuf:"bytes,2,opt,name=place_full_name,json=placeFullName,proto3" json:"place_full_name,omitempty"`
}
...
func (x *Duty) GetTeacherFullName() string {
	if x != nil {
...
func (x *Duty) GetPlaceFullName() string {
	if x != nil {
		return x.PlaceFullName
	}
	return ""
}
...
func (x *DutyGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DutyGroup) ProtoMessage() {}

func (x *DutyGroup) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DutyGroup.ProtoReflect.Descriptor instead.
func (*DutyGroup) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{20}
}

func (x *DutyGroup) GetDuties() []*Duty {
	if x != nil {
		return x.Duties
	}
	return nil
...
func (x *DutyGroup) GetTimeRange() *TimeRange {
	if x != nil {
		return x.TimeRange
	}
	return nil
...
type TeachersOnDuty struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DayOfWeek  string       `protobuf:"bytes,1,opt,name=day_of_week,json=dayOfWeek,proto3" json:"day_of_week,omitempty"`
	DutyGroups []*DutyGroup `protobuf:"bytes,2,rep,name=duty_groups,json=dutyGroups,proto3" json:"duty_groups,omitempty"`
}

func (x *TeachersOnDuty) Reset() {
	*x = TeachersOnDuty{}
...
func (x *TeachersOnDuty) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeachersOnDuty) ProtoMessage() {}

func (x *TeachersOnDuty) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeachersOnDuty.ProtoReflect.Descriptor instead.
func (*TeachersOnDuty) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{21}
}

func (x *TeachersOnDuty) GetDayOfWeek() string {
	if x != nil {
		return x.DayOfWeek
	}
	return ""
...
func (x *TeachersOnDuty) GetDutyGroups() []*DutyGroup {
	if x != nil {
		return x.DutyGroups
	}
	return nil
...
type TeachersOnDutyWeek struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TeachersOnDuty []*TeachersOnDuty `protobuf:"bytes,1,rep,name=teachers_on_duty,json=teachersOnDuty,proto3" json:"teachers_on_duty,omitempty"`
}

func (x *TeachersOnDutyWeek) Reset() {
	*x = TeachersOnDutyWeek{}
	mi := &file_data_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *TeachersOnDutyWeek) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeachersOnDutyWeek) ProtoMessage() {}

func (x *TeachersOnDutyWeek) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeachersOnDutyWeek.ProtoReflect.Descriptor instead.
func (*TeachersOnDutyWeek) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{22}
}

func (x *TeachersOnDutyWeek) GetTeachersOnDuty() []*TeachersOnDuty {
	if x != nil {
		return x.TeachersOnDuty
	}
	return nil
}

type PracticesGroup struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	DivisionDesignators []string   `protobuf:"bytes,1,rep,name=division_designators,json=divisionDesignators,proto3" json:"division_designators,omitempty"`
	TimeRange           *TimeRange `protobuf:"bytes,2,opt,name=time_range,json=timeRange,proto3" json:"time_range,omitempty"`
}

func (x *PracticesGroup) Reset() {
	*x = PracticesGroup{}
...
func (x *PracticesGroup) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PracticesGroup) ProtoMessage() {}

func (x *PracticesGroup) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PracticesGroup.ProtoReflect.Descriptor instead.
func (*PracticesGroup) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{23}
}

func (x *PracticesGroup) GetDivisionDesignators() []string {
	if x != nil {
		return x.DivisionDesignators
	}
	return nil
}

func (x *PracticesGroup) GetTimeRange() *TimeRange {
	if x != nil {
		return x.TimeRange
	}
	return nil
...
type Practices struct {
	...
	PracticesGroups []*PracticesGroup `protobuf:"bytes,1,rep,name=practices_groups,json=practicesGroups,proto3" json:"practices_groups,omitempty"`
}

func (x *Practices) Reset() {
	*x = Practices{}
...
func (x *Practices) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Practices) ProtoMessage() {}

func (x *Practices) ProtoReflect() protoreflect.Message {
	mi := &file_data_proto_msgTypes[24]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Practices.ProtoReflect.Descriptor instead.
func (*Practices) Descriptor() ([]byte, []int) {
	return file_data_proto_rawDescGZIP(), []int{24}
}

func (x *Practices) GetPracticesGroups() []*PracticesGroup {
	if x != nil {
		return x.PracticesGroups
	}
	return nil
}
...
var file_data_proto_rawDesc = []byte{
	...
	0x01, 0x22, 0x8b, 0x01, 0x0a, 0x09, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x12,
	...
	,
...
var file_data_proto_goTypes = []any{
	...
	(*Duty)(nil),                   // 19: data.Duty
	(*DutyGroup)(nil),              // 20: data.DutyGroup
	(*TeachersOnDuty)(nil),         // 21: data.TeachersOnDuty
	(*TeachersOnDutyWeek)(nil),     // 22: data.TeachersOnDutyWeek
	(*PracticesGroup)(nil),         // 23: data.PracticesGroup
	(*Practices)(nil),              // 24: data.Practices
	(*School)(nil),                 // 25: data.School
	nil,                            // 26: data.Metadata.DesignatorsEntry
	nil,                            // 27: data.Metadata.FullNamesEntry
	nil,                            // 28: data.AirPollutionResponse.ComponentsEntry
}
var file_data_proto_depIdxs = []int32{
	26, // 0: data.Metadata.designators:type_name -> data.Metadata.DesignatorsEntry
	27, // 1: data.Metadata.full_names:type_name -> data.Metadata.FullNamesEntry
	...
	28, // 7: data.AirPollutionResponse.components:type_name -> data.AirPollutionResponse.ComponentsEntry
	...
	19, // 17: data.DutyGroup.duties:type_name -> data.Duty
	11, // 18: data.DutyGroup.time_range:type_name -> data.TimeRange
	20, // 19: data.TeachersOnDuty.duty_groups:type_name -> data.DutyGroup
	21, // 20: data.TeachersOnDutyWeek.teachers_on_duty:type_name -> data.TeachersOnDuty
	11, // 21: data.PracticesGroup.time_range:type_name -> data.TimeRange
	23, // 22: data.Practices.practices_groups:type_name -> data.PracticesGroup
	18, // 23: data.School.divisions:type_name -> data.Division
	16, // 24: data.School.teachers:type_name -> data.Teacher
	17, // 25: data.School.rooms:type_name -> data.Room
	2,  // 26: data.Metadata.DesignatorsEntry.value:type_name -> data.Duplicates
	2,  // 27: data.Metadata.FullNamesEntry.value:type_name -> data.Duplicates
